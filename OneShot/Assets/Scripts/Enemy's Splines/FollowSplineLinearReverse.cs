...
public class FollowSplineLinearReverse : MonoBehaviour
{
    private Coroutine coroutine;
    public SplineContainer SplineLinearReverse;
    public float duration = TimingController2.Instance.startTimer * 2;
    ...
    void Start()
    {
        ...
        duration = TimingController2.Instance.startTimer * 2;
    }
